...
curl -X POST -H "Content-Type: application/json" \
  -d '{"query": "mutation { login(email: \"test.Brakus@gmail.com\", password: \"123456\") { user { id, name, role, email }, token, userToken } }"}' \
  ...
  http://localhost:4000/graphql | jq
{
  "data": {
    "login": {
      ...
      "token": "aJ0uw2smzO7OXJlSkGCkiVFGkUDLdLhvu1ZQRrUQIB0=",
      "userToken": "ucGlimH3Oh7UfHtQ62hbKKwAkFM0Rt0MaJTzV1227VlEqzab4S9PRlO+S4oKi8gS7I4r9nAq7VWg4jA8kLDJ1SBE0My+Tl+nJxBJ7VFl2t0="
    }
  }
}
...
curl -X POST -H "Content-Type: application/json" \
  -d '{"query": "mutation { decryptUserToken(userToken: \"ucGlimH3Oh7UfHtQ62hbKKwAkFM0Rt0MaJTzV1227VlEqzab4S9PRlO+S4oKi8gS7I4r9nAq7VWg4jA8kLDJ1SBE0My+Tl+nJxBJ7VFl2t0=\") { user { id, name, role, email }, token } }"}' \
  http://localhost:4000/graphql | jq
{
  "data": {
    "decryptUserToken": {
...
curl -X POST -H "Content-Type: application/json" \
  -d '{"query": "mutation { auth(user: {name: \"John\", email: \"john@example.com\", image: \"profile.jpg\"}, account: {provider: \"email\"}) { user { id, name, email, image, role, status, updated_at, created_at }, token } }"}' \
  http://localhost:4000/graphql | jq
{
  "data": {
    "auth": {
      "user": {
        ...
        "role": "user",
        "status": true,
        "updated_at": "2024-02-26 08:12:52",
        "created_at": "2024-02-26 08:12:52"
      },
      "token": "LT8erleFdGc0uefaBbgF1SSxBwOotjeVAIqaLdzm28E="
    }
  }
}
...
curl -X POST -H "Content-Type: application/json" \
  -H "x-access-token: LT8erleFdGc0uefaBbgF1SSxBwOotjeVAIqaLdzm28E=" \
...
curl -X POST -H "Content-Type: application/json" \
  -H "x-access-token: aJ0uw2smzO7OXJlSkGCkiVFGkUDLdLhvu1ZQRrUQIB0=" \
  ...
  "data": {
    "topUsersByLikeCount": [
      ...
      },
      {
        "id": "45",
        "name": "DANA BECHTELAR",
        "email": "dana.bechtelar80@gmail.com",
        "image": "https://avatars.githubusercontent.com/u/89545549",
        "role": "user",
        "followed": false,
        "followers_count": 7,
        "country": "Bangladesh",
