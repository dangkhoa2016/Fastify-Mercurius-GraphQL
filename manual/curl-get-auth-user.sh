  ...
  http://localhost:4000/graphql | jq
{
  "data": {
    "login": {
      ...
      "token": "aOc+nf0PMwEPhYJE01AWypuFu+9okDX/6pv2E5VJSFE=",
      "userToken": "UiD5bVWKUe4IxQnl1EvSbgzQIgvQ8aj2+xqujFCnhqTtvUCwnpKBVP7RtTumDKndANplgMNnOng5dAgD2yVgzSBE0My+Tl+nJxBJ7VFl2t0="
    }
  }
}
...
curl -X POST -H "Content-Type: application/json" \
  -d '{"query": "mutation { decryptUserToken(userToken: \"UiD5bVWKUe4IxQnl1EvSbgzQIgvQ8aj2+xqujFCnhqTtvUCwnpKBVP7RtTumDKndANplgMNnOng5dAgD2yVgzSBE0My+Tl+nJxBJ7VFl2t0=\") { user { id, name, role, email }, token } }"}' \
  http://localhost:4000/graphql | jq
{
  "data": {
    "decryptUserToken": {
...
curl -X POST -H "Content-Type: application/json" \
  -H "x-access-token: aOc+nf0PMwEPhYJE01AWypuFu+9okDX/6pv2E5VJSFE=" \
    ...
    "catsByUserId": {
      "items": [
        ...
        },
        {
          "id": "181",
          "name": "Snowshoe",
          "image": "https://placekitten.com/400/319",
          "description": "Quae solium similique acer cupressus. Solus soluta defessus degero. Uredo celer universe absens crastinus chirographum.",
          "coat_color": "teal",
          "eye_color": "magenta",
  ...
  http://localhost:4000/graphql | jq
{
  ...
  "errors": [
    {
      "message": "The cat that these photos belong to is not active",
      "locations": [
        {
          "line": 1,
          "column": 9
